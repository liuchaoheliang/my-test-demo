...
public class ZooKeeperOperator extends AbstractZooKeeper {  
    ...
    public void setData(String path,String data) throws KeeperException, InterruptedException, UnsupportedEncodingException {     
    	...
    	this.zooKeeper.setData(path, data.getBytes(),stat.getVersion());     
    }
    
    public void register(Watcher watcher ) throws KeeperException, InterruptedException, UnsupportedEncodingException {     
        this.zooKeeper.register(watcher); 
    }
     public static void main(String[] args) {  
         try {     
                ZooKeeperOperator zkoperator = new ZooKeeperOperator();     
                zkoperator.connect("localhost:34297"); 
                zkoperator.create("/zk/client3", "".getBytes());
//                byte[] data = new byte[]{'a','b','c','d'};     
                     
//                zkoperator.setData("/zk","mmmmm");     
...
//                zkoperator.getChild("/root");  
                while(true){
                	...
                	//System.out.println("获取到的值："+zkoperator.getData("/zk"));
